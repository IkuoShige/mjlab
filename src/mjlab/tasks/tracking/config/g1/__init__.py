...
from .env_cfgs import (
  unitree_g1_flat_multimotion_tracking_env_cfg,
...
# Multi-motion tracking (HumanoidSoccer Stage 1).
register_mjlab_task(
  task_id="Mjlab-Tracking-MultiMotion-Flat-Unitree-G1",
  env_cfg=unitree_g1_flat_multimotion_tracking_env_cfg(),
  play_env_cfg=unitree_g1_flat_multimotion_tracking_env_cfg(play=True),
  rl_cfg=unitree_g1_tracking_ppo_runner_cfg(),
  runner_cls=MotionTrackingOnPolicyRunner,
)
